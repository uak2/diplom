...
class SpecialitiesControllerTest < ActionController::TestCase
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post :create, speciality: { form_name: @speciality.form_name, form_number: @speciality.form_number, level: @speciality.level, name: @speciality.name, number: @speciality.number }
    end
  ...
  test "should update speciality" do
    patch :update, id: @speciality, speciality: { form_name: @speciality.form_name, form_number: @speciality.form_number, level: @speciality.level, name: @speciality.name, number: @speciality.number }
    assert_redirected_to speciality_path(assigns(:speciality))
  end
